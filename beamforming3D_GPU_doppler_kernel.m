%% GPU beamformer kernel for 3D IQ data
% Beamforms images given RData,Receive,TX,P,Trans objects
% Author - Kyle McGraw
% Written on August 2022
% 

function IQs = beamforming3D_GPU_doppler_kernel(RData,Receive,TX,Trans,P);
...
%             fprintf('\n\tdop: %d\n\tframe: %d\n\trcv: %d\n', dop_num, frame_num, rcv);
            ...
            data=gpuArray(int16(RData(dop_num,frame_num,:,:)));
